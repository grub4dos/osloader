...
typedef struct _FILE_INFORMATION
{
	...
	// start address
	//
	ULARGE_INTEGER										StartingAddress;

	//
	// end address
	//
	ULARGE_INTEGER										EndingAddress;
...
// seek
//
typedef ARC_STATUS (*PARC_SEEK_ROUTINE)(__in ULONG FileId,__in PULARGE_INTEGER Offset,__in SEEK_MODE SeekMode);
