...
// lsn
//
typedef ULARGE_INTEGER									LSN,*PLSN;

//
// lcn
//
typedef ULONGLONG										LCN,*PLCN;

//
// vcn
//
typedef ULONGLONG										VCN,*PVCN;

//
// lbo
//
typedef ULONGLONG										LBO,*PLBO;


//
// vbo
//
typedef ULONGLONG										VBO,*PVBO;
...
// seek
//
ARC_STATUS NtfsSeek(__in ULONG FileId,__in PULARGE_INTEGER Offset,__in SEEK_MODE SeekMode)
{
	PBL_FILE_TABLE FileTableEntry						= &BlFileTable[FileId];
